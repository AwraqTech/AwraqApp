                ...
                {financialLinks.map((nav, index) => (
                    <div key={index} className="w-full">
                        ...
                        >
                            ...
                            {nav.isCollapsable && (
                                <i
                                    className={`ri-arrow-${openMenus.includes(nav.link)
                                        ? "down"
                                        : isArabic
                                            ? "right"
                                            : "left"
                            ...
                            <div className="flex flex-col gap-2 pl-8 mt-2">
                                {nav.subNav?.map((subNav, subIndex) => (
                                    <Link
                                        key={subIndex}
                                        href={subNav.link}
                                        className={`py-2 px-4 rounded-lg hover:dark:bg-[#111c2a] hover:bg-[#f1f1f1] ${isActive(subNav.link) ? "bg-[#f1f1f1] dark:bg-[#111c2a]" : ""
                                            }`}
                                    >
                                        {subNav.title}
                                    </Link>
